## Eduardo Fallas Valverde

Mechatronics engineering student at **Tecnológico de Costa Rica** (Cartago), graduating 2027.
I work across embedded systems, robotics and predictive modelling — and I care more about
whether a result survives an honest test than about how large it looks.

**Open to** a paid internship or junior role in **mechatronics** or **data analysis**,
in or near Cartago, Costa Rica.
...
| **Data / ML** | XGBoost, scikit-learn, pandas, NumPy, SciPy — temporal validation, probability calibration |
| **Embedded** | ESP32, Arduino, ROS 2, OpenCV / ArUco |
| **Design** | KiCad (PCB), SolidWorks |
| **Environment** | Git, Linux (Arch), Webots |
...
- **Dassault Systèmes** — Certified SolidWorks Associate (CSWA)

### Contact

[fallasev@zohomail.com](mailto:fallasev@zohomail.com)
